...
/**
 * Copy all server resources that are not TypeScript files into build directory.
 */
...
gulp.task("build", function (callback) {
    runSequence('clean', 'build:server', 'build:client', 'resources', 'serverResources', 'libs', callback);
});